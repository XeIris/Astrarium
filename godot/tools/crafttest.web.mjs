...
// godot/tools/crafttest.gd / craftsheet.gd. A sibling of webref.mjs (same
...
//
//   WEB_ROOT=/path/to/checkout PORT=8799 node godot/tools/crafttest.web.mjs outdir [numbers] [shots] [sheet]
//
