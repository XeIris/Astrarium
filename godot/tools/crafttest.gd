...
#
#   Godot --path godot res://tools/crafttest.tscn -- v=saturnv view=side out=/abs.png
...
#
#   Godot --headless --path godot res://tools/crafttest.tscn -- audit [assets=0]
#   Godot --headless --path godot res://tools/crafttest.tscn -- clearance [assets=0]
