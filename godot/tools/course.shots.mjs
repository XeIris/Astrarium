// The course's web reference shot list, for godot/tools/webref.mjs:
//
//   node godot/tools/course.shots.mjs > /tmp/course/shots.json
//   PORT=8805 WEB_ROOT=<checkout with assets> node godot/tools/webref.mjs /tmp/course/shots.json /tmp/course/web
//
// Each UI shot resets the progress, opens a lesson, presses Next `n` times and
// pumps `frames` fixed frames — godot/tools/coursetest.tscn does the same with
...
// report), which godot/tools/sciencecheck.gd checks against.
