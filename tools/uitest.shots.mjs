...
//
//   node tools/uitest.shots.mjs /tmp/ui/shots.json [--flat]
//   PORT=8797 WEB_ROOT=<checkout with assets> node tools/webref.mjs /tmp/ui/shots.json /tmp/ui/web
//
...
// the committed reference set (tools/ref/ui), small and pixel-diffable.
