...
//   node tools/gen_lessons.mjs > sim/lessons.gd
import { readFileSync } from 'node:fs';
import { pathToFileURL } from 'node:url';
import { resolve } from 'node:path';

const src = readFileSync('web/sim/lessons.js', 'utf8').split('\n');
const L = await import(pathToFileURL(resolve('web/sim/lessons.js')).href);
