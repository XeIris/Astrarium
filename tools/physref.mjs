...
//       writes cases + results. tools/physcheck.gd reads the same file,
//       recomputes every case in GDScript and writes its own; physdiff.mjs
//       compares the two.
//   node tools/physref.mjs long <preset> <simYears> [fps]
...
//
// 'three' is mapped to tools/three_stub.mjs by a resolve hook, so the web
...
if (mode === 'ref') {
  ...
  // The published calibrations AGENTS.md names, as numbers.
