...
const R = await import('../web/sim/flight/rocketry.js');
const VH = await import('../web/sim/flight/vehicles.js');
const O = await import('../web/sim/flight/orbit.js');
const VS = await import('../web/sim/flight/vessel.js');
const GD = await import('../web/sim/flight/guidance.js');
const RL = await import('../web/sim/flight/relativity.js');
