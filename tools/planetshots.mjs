...
//
//   node tools/planetshots.mjs /abs/shots.json
//   PORT=8795 WEB_ROOT=<checkout> node tools/webref.mjs /abs/shots.json outdir/
//   Godot --path . res://tools/planettest.tscn -- scene=outdir/<name>.json \
