...
This is the archived, runnable HTML/Three.js version. The Godot project at the
repository root is the main version. This document remains the physics and
scenario reference for both versions.
...
It's static — from the repository root, serve the web folder and open
`blackhole_sim.html`:
