...
function attachVisual(b) {
  ...
  // temperature the imaging bands re-image from (AGENTS.md: emitters publish
...
function editBody(b, patch) {
  ...
  if (patch.mass != null) {
    ...
    // Measured beats modelled (AGENTS.md) — but a measurement describes ONE
...
function transmute(b, newType, why) {
  ...
  if (newType === 'bh') {
    ...
    // re-imaging it as a star in the non-visible bands (see AGENTS.md).
  ...
  // rebuilt from its spec the way a spawn or an edit would build it (AGENTS.md:
